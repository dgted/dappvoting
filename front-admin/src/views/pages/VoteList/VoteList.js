            ...
            <CTable bordered hover responsive  spacing={0}>
                <CTableHead>
                    <CTableRow>
                        ...
                        <CTableHeaderCell scope="col">Voter Wallet Address </CTableHeaderCell>
                        <CTableHeaderCell scope="col">Solana Transections </CTableHeaderCell>
                        <CTableHeaderCell scope="col">User Vote Selection </CTableHeaderCell>
                    </CTableRow>
                </CTableHead>
                <CTableBody>
                    ...
                    {Users.map((Users, idx) => (
                        <CTableRow key={idx}>
                            ...
                            <CTableDataCell>{Users?.voter_wallet_address}</CTableDataCell>
                            <CTableDataCell>{Users?.solana_transaction_id}</CTableDataCell>
                            <CTableDataCell>{Users?.option?.name}</CTableDataCell>
